...
public partial class Login : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (operation.Logon(ManagerUser.Text, ManagerPWD.Text).Tables[0].Rows.Count > 0)  //判断用户是否合法。
        {
            Session.Add("UserName", ManagerUser.Text.Trim());  //将用户名称存储在Session中,用于判断非法用户进行后台。

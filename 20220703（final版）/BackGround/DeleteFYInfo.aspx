<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteFYInfo.aspx.cs" Inherits="BackGround_DeleteInfo" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <table class="table table-hover" align="left" style="width: 94%">
